						...
						<div class="collapse" id="dashboard-collapse" style="">
							<ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
								<c:forEach var="ao" items="${ shirt }">
									<li style="padding: 5px 0px; padding-left: 15px"><a href="/Assignment_Java4_SOF3011/admin/categories/show?ten=${ ao.ten }" class="link-dark rounded" id="afocus">${ ao.ten }</a></li>
								</c:forEach>	
							</ul>
						</div>
					</li>
						...
						<div class="collapse" id="orders-collapse" style="">
							<ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
								<c:forEach var="quan" items="${ trousers }">
									<li style="padding: 5px 0px; padding-left: 15px"><a href="/Assignment_Java4_SOF3011/admin/categories/show?ten=${ quan.ten }" class="link-dark rounded" id="afocus">${ quan.ten }</a></li>
								</c:forEach>	
							</ul>
						</div>
					</li>
						...
						<div class="product-item women">
							<div class="product product_filter">
								...
								<div class="product_info">
									<h6 class="product_name"><a href="single.html">${ obj.ten }</a></h6>
